...
- `whoami`: confirm connection and remaining credits before spending anything. If FastestRank is not connected, stop and ask the user to connect it.
...
7. **How this report was made** — opens with the skill link line from `seo-report`, pointing at `https://www.fastestrank.com/docs/skills/seo-audit` ("FastestRank SEO Audit skill"), then what the tools reported and what you verified by hand.

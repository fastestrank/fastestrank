...
# FastestRank Competitor Analysis
...
7. **How this report was made** — opens with the skill link line from `seo-report`, pointing at `https://www.fastestrank.com/docs/skills/competitor-analysis` ("FastestRank Competitor Analysis skill"), then which tools reported what, and what you checked yourself.

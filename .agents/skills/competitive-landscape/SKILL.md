...
# FastestRank Competitive Landscape
...
6. **How this report was made** — opens with the skill link line from `seo-report`, pointing at `https://www.fastestrank.com/docs/skills/competitive-landscape` ("FastestRank Competitive Landscape skill"), then the query set used, and a note calling the read directional when the query set was small.

## Guardrails

- Distinguish SEO competitors from business competitors.
- Do not overstate exact traffic when FastestRank returns estimates.

...
# FastestRank Keyword Clustering
...
6. **How this report was made** — opens with the skill link line from `seo-report`, pointing at `https://www.fastestrank.com/docs/skills/keyword-clustering` ("FastestRank Keyword Clustering skill"), then where the keywords came from, and a note labelling target pages as proposed when no URL data was supplied.
